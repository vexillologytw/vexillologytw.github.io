var monjiImages = [
    ...
    {en:"monji-of-chiayi-county", md:"嘉義縣章", level:1, parent:null, title_en:"Chiayi County", title_md:"嘉義縣", desc:"台灣第一高山玉山就矗立於嘉義縣，三重山岳的形狀象徵高山巍峨壯麗延綿，代表台灣民族的堅毅正直率真豪情。", desc_inherit:false},
    ...
    {en:"monji-of-taichung-city-10-1", md:"台中市章十式", level:2, parent:"monji-of-taichung-city", title_en:"Taichung City II", title_md:"台中市十式", desc:"", desc_inherit:false},
    {en:"monji-of-taichung-city-11-1", md:"台中市章十一式", level:2, parent:"monji-of-taichung-city", title_en:"Taichung City III", title_md:"台中市十一式", desc:"", desc_inherit:false},
    ...
    {en:"monji-of-takaohsiung-city", md:"高雄市章", level:1, parent:null, title_en:"Kaohsiung City", title_en:"Kaohsiung City", title_md:"高雄市", desc:"擁有全台第一大港的高雄市位於台灣南部，是台灣人口規模第三大的城市。<br><br>紋結合了「高」字與日本時代的高雄市章，象徵這座城市繼承的歷史與人文。<br><br>紋自上而下可分為三個菱形區塊，分別象徵和平、民主與自由。", desc_inherit:false},
    {en:"monji-of-qieding-kaohsiung-city", md:"茄萣區章", level:2, parent:"monji-of-takaohsiung-city", title_en:"Qieding Dictrict", title_md:"茄萣區", desc:"", desc_inherit:false},
    {en:"monji-of-neimen-kaohsiung-city", md:"內門區章", level:2, parent:"monji-of-takaohsiung-city", title_en:"Neimen Dictrict", title_md:"內門區", desc:"", desc_inherit:false},
    {en:"monji-of-sanmin-kaohsiung-city", md:"三民區章", level:2, parent:"monji-of-takaohsiung-city", title_en:"Sanmin Dictrict", title_md:"三民區", desc:"紋由三個「民」字組成，代表民主民享民心。", desc_inherit:false},
    {en:"monji-of-sinsing-kaohsiung-city", md:"新興區章", level:2, parent:"monji-of-takaohsiung-city", title_en:"Sinsing Dictrict", title_md:"新興區", desc:"", desc_inherit:false},
