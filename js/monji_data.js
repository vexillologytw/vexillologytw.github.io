var monjiImages = [
    ...
    {en:"monji-of-ershui-changhua-county", md:"彰化縣二水鄉", level:2, detail:true, parent:"monji-of-changhua-county", title_en:"Ershui Dictrict", title_md:"彰化縣二水鄉", desc:""},
    ...
    {en:"monji-of-hsinchu-city", md:"新竹市", level:1, detail:true, parent:null, title_en:"Hsintsu City", title_md:"新竹市", desc:"位於台灣北部的新竹市是台灣的科技重鎮，世界第一的半導體製造公司台積電總部就坐落於此。<br><br>紋由「竹」與「市」字所組成，可分為三個區塊，分別象徵科學、創新與永續發展。"},
    ...
    {en:"monji-of-tainan-city", md:"台南市", level:1, detail:true, parent:null, title_en:"Tainan City", title_md:"台南市", desc:"台南市是台灣島上最早有人類活動的地區之一，其保存了上百年的歷史古蹟與飲食文化，是台灣重要的文明寶地。<br><br>台南市章由外側二重環與內側繩結組合成「南」字。二重環象徵永保與安康；繩結連結上下的意象，象徵天地人美滿和諧。"},
    {en:"monji-of-annan-tainan-city", md:"台南市安南區", level:2, detail:true, parent:"monji-of-tainan-city", title_en:"Annan Dictrict", title_md:"台南市安南區", desc:""},
    {en:"monji-of-west-central-tainan-city", md:"台南市中西區", level:2, detail:true, parent:"monji-of-tainan-city", title_en:"West Central Dictrict", title_md:"台南市中西區", desc:""},
    {en:"monji-of-gueiren-tainan-city", md:"台南市歸仁區", level:2, detail:true, parent:"monji-of-tainan-city", title_en:"Gueiren Dictrict", title_md:"台南市歸仁區", desc:""},
    {en:"monji-of-baihe-tainan-city", md:"台南市白河區", level:2, detail:true, parent:"monji-of-tainan-city", title_en:"Baihe Dictrict", title_md:"台南市白河區", desc:""},
    ...
    {en:"monji-of-qieding-kaohsiung-city", md:"高雄市茄萣區", level:2, detail:true, parent:"monji-of-takaohsiung-city", title_en:"Qieding Dictrict", title_md:"高雄市茄萣區", desc:""},
    {en:"monji-of-neimen-kaohsiung-city", md:"高雄市內門區", level:2, detail:true, parent:"monji-of-takaohsiung-city", title_en:"Neimen Dictrict", title_md:"高雄市內門區", desc:""},
    {en:"monji-of-sanmin-kaohsiung-city", md:"高雄市三民區", level:2, detail:true, parent:"monji-of-takaohsiung-city", title_en:"Sanmin Dictrict", title_md:"高雄市三民區", desc:""},
    {en:"monji-of-sinsing-kaohsiung-city", md:"高雄市新興區", level:2, detail:true, parent:"monji-of-takaohsiung-city", title_en:"Sinsing Dictrict", title_md:"高雄市新興區", desc:""},
    ...
    {en:"monji-of-taixi-yunlin-county", md:"雲林縣台西鄉", level:2, detail:true, parent:"monji-of-yunlin-county", title_en:"Taixi Dictrict", title_md:"雲林縣台西鄉", desc:""}
];
var monjiConfig = {
    dir: "/images/monjis/",
    container: "#monji-ctn",
