var flagImages = [
    {en:"flag-of-taiwan-1-1", md:"台灣百合旗", level:1, parent:null, title_en:"Flag of Taiwan", title_md:"台灣百合旗", desc:"藍色象徵海洋，代表正義與民主。<br><br>青色象徵山岳，代表生命與自由。<br><br>黃色象徵台灣人，代表文明與繁榮。<br><br>白色象徵天空，代表善良與和諧。<br><br>百合象徵不屈的精神，也代表台灣本土歷史與濃厚人文。<br><br>圓象徵台灣多個民族的共和共榮。<br><br>向外散發的線條象徵台灣走向世界，發揚台灣之光。", desc_inherit:false, colors:"003255,00b4b2,ffd700,ffffff", colors_inherit:false, tags:"lily", tags_inherit:false},
    ...
    {en:"flag-of-red-lily-1-1", md:"紅百合旗", level:2, parent:"flag-of-taiwan-1-1", title_en:"Flag of Red Lily", title_md:"紅百合旗", desc:"藍色象徵海洋，代表正義與民主。<br><br>紅色象徵生命，代表真誠與力量。<br><br>黃色象徵台灣人，代表文明與繁榮。<br><br>白色象徵天空，代表善良與和諧。<br><br>百合象徵不屈的精神，也代表台灣本土歷史與濃厚人文。<br><br>圓象徵台灣多個民族的共和共榮。<br><br>向外散發的線條象徵台灣走向世界，發揚台灣之光。", desc_inherit:false, colors:"003255,b40000,ffd700,ffffff", colors_inherit:false, tags:"", tags_inherit:true},
    ...
    {en:"flag-of-four-languages", md:"四大語言族群旗", level:1, parent:null, title_en:"Flag of Four Ethnics", title_md:"四大語言族群旗", desc:"紅色代表守護自由的決心。<br><br>白色代表善良樸實的美德。<br><br>四條線分別代表台灣四大語言族群：中文、台語、客語、以及原住民語。<br><br>線條重疊而形成的八芒星，象徵多個民族的命運，在歷史的推動下交織在台灣島上。", desc_inherit:false, colors:"b40014,ffffff", colors_inherit:false, tags:"four_languages,intersect_lines", tags_inherit:false},
    ...
    {en:"flag-of-four-languages-2", md:"四大語言族群旗二號", level:2, parent:"flag-of-four-languages", title_en:"Flag of Four Ethnics II", title_md:"四大語言族群旗二號", desc:"藍色象徵台灣人的熱情與活力，代表自由與智慧。白色的背景象徵處處融洽，代表善良與樸實。<br><br>旗中央相互環繞的魚組成了圓，象徵多個民族跨海來台落地生根，並最終合而為一成了共和共榮的台灣民族。<br><br>這四條魚分別代表台灣四大語言族群：中文、台語、客語、原住民語。", desc_inherit:false, colors:"00509F,ffffff", colors_inherit:false, tags:"four_languages,fish", tags_inherit:false},
    
    {en:"flag-of-three-whales-1-1", md:"三鯨旗", level:1, parent:null, title_en:"Flag of Three Whales", title_md:"三鯨旗", desc:"白色代表和諧與善良；藍色代表生命與正義。<br><br>三條鯨魚代表台灣的獨立、民主與自由。<br><br>鯨魚們相互環繞的意象，象徵台灣與海洋無法分離的緊密聯繫。", desc_inherit:false, colors:"003c78,ffffff", colors_inherit:false, tags:"whale,fish", tags_inherit:false},
    ...
    {en:"flag-of-department-of-finance", md:"財政部旗", level:1, parent:null, title_en:"Flag of Department of Finance", title_md:"財政部旗", desc:null, desc_inherit:false, colors:"003255,ffd700", colors_inherit:false, tags:"finance", tags_inherit:false},
    {en:"flag-of-coast-guard", md:"海巡署旗", level:2, parent:null, title_en:"Flag of Coast Guard", title_md:"海巡署旗", desc:"藍色象徵海疆，代表穩重與正義。<br><br>黃色象徵台灣人，代表智慧與忠誠。<br><br>旗章由「巡」字圖案化而成，紋上三道條紋分別代表警察、軍人與公務人員。", desc_inherit:false, colors:"003255,ffd700", colors_inherit:false, tags:"coast_guard", tags_inherit:false},
    {en:"flag-of-coast-guard-naval", md:"海巡署海上旗", level:1, parent:"flag-of-coast-guard", title_en:"Navel Ensign of Coast Guard", title_md:"海巡署海上旗", desc:"藍色象徵海疆，代表穩重與正義。<br><br>橘色象徵海巡隊員，代表力量與衛國決心。<br><br>白色象徵船艦，代表拯救與生命。<br><br>旗章由「巡」字圖案化而成，紋上三道條紋分別代表警察、軍人與公務人員。", desc_inherit:false, colors:"003255,ff4915,ffffff", colors_inherit:false, tags:"coast_guard,water", tags_inherit:false},
    
    {en:"flag-of-kaohsiung-city", md:"高雄市旗", level:1, parent:null, title_en:"Flag of Kaohsiung", title_md:"高雄市旗", desc:"藍色代表港都的歷史與文化。<br><br>白色代表熱情與活力。<br><br>旗中央是代表高雄的高字紋（「高」字與日治高雄市徽的結合體），八道條紋象徵孕育高雄的八大流域。<br><br>條紋又形成山形，象徵高雄水色山光。", desc_inherit:false, colors:"004174,ffffff", colors_inherit:false, tags:"reginal,mountain,water", tags_inherit:false},
    {en:"flag-of-keelung-city", md:"基隆市旗", level:1, parent:null, title_en:"Flag of Keelung", title_md:"基隆市旗", desc:"藍色與黃色象徵夜空下的基隆燈火，代表寧靜與繁榮。<br><br>白色象徵海浪，代表長久的平安。<br><br>中央的基字紋代表基隆市。<br><br>位於藍色區域的七角星象徵基隆的七個附屬島嶼，代表自由。<br><br>位於黃色區域的七角星象徵基隆的七個行政區，代表民主。", desc_inherit:false, colors:"004574,ffd45f,ffffff", colors_inherit:false, tags:"reginal,water", tags_inherit:false},
    {en:"flag-of-taipei-city", md:"台北市旗", level:1, parent:null, title_en:"Flag of Taipei", title_md:"台北市旗", desc:"藍色代表和平。<br><br>金色代表繁榮。<br><br>兩道條紋代表民主與自由。<br><br>旗中央的三個北字代表在金融、社會與文化的蓬勃發展。<br><br>六顆星象徵台北是台灣政治、國防、經貿、科技、教育與人文的核心都市。", desc_inherit:false, colors:"004574,ffd45f", colors_inherit:false, tags:"reginal", tags_inherit:false},
    {en:"flag-of-penghu-county", md:"澎湖縣旗", level:1, parent:null, title_en:"Flag of Penghu County", title_md:"澎湖縣旗", desc:"青色象徵蒼海，代表澎湖人對自然的敬畏。<br><br>白色象徵純淨，代表澎湖人的純樸與友善。<br><br>黃色象徵陽光，代表澎湖人的熱情與活力。<br><br>三道條紋由長到短，分別象徵澎湖群島的歷史、人文、以及現代化的發展。<br><br>左方的紋由六道海與橋梁組成「澎」字，代表澎湖六個行政區共存共榮。", desc_inherit:false, colors:"009d9f,ffe36a,ffffff", colors_inherit:false, tags:"reginal,water", tags_inherit:false},
    {en:"flag-of-changhua-county", md:"彰化縣旗", level:1, parent:null, title_en:"Flag of Chnaghua County", title_md:"彰化縣旗", desc:null, desc_inherit:false, colors:"00a2b4,ffffff", colors_inherit:false, tags:"reginal,mountain", tags_inherit:false},
    {en:"flag-of-taitung-county", md:"台東縣旗", level:1, parent:null, title_en:"Flag of Taitung County", title_md:"台東縣旗", desc:"白色象徵晴天，代表自由與希望。<br><br>藍色象徵大海，代表生命與敬畏。<br><br>黃色象徵旭日，代表天地萬物生生不息。<br><br>旗中央是代表台東的東字紋，層層環繞的意象代表緊守層層祝福。", desc_inherit:false, colors:"005d8a,ffc755,ffffff", colors_inherit:false, tags:"reginal,water,sun", tags_inherit:false},
    {en:"flag-of-chiayi-county", md:"嘉義縣旗", level:1, parent:null, title_en:"Flag of Chiayi County", title_md:"嘉義縣旗", desc:null, desc_inherit:false, colors:"00b4b2,ffffff", colors_inherit:false, tags:"reginal,mountain", tags_inherit:false},
    {en:"flag-of-hsintsu-city", md:"新竹市旗", level:1, parent:null, title_en:"Flag of Hsintsu City", title_md:"新竹市旗", desc:"磚紅色代表新竹的濃厚歷史與人文。<br><br>金黃色代表富裕與發達。<br><br>白色代表正直與善良。<br><br>旗中央是代表新竹的「竹市」字紋。十字象徵新竹並存於傳統與現代。五芒星象徵新竹世界頂尖的科技實力。", desc_inherit:false, colors:"b42300,ffb315,ffffff", colors_inherit:false, tags:"reginal,cross", tags_inherit:false},
...
/**
 * get a flag object by its parent's english name.
...
/**
 * get the previous & following flag objects.
 * @param {string} en 
 * @returns 
 */
...
/**
 * get all of decedent flags.
 * @param {string} en 
 * @returns 
 */
function getFlagChildrenCount(en) {
	var count = 0;
	for (var flag of flagImages) {
		if (flag.parent === en) {
			count++;
...
/**
 * get a flag's description or its ascendent's description.
 * @param {string} en 
 * @returns 
 */
...
/**
 * get a flag's colors or its ascendent's colors.
 * @param {string} en 
 * @returns 
 */
...
/**
 * get a flag's tags or its ascendent's tags.
 * @param {String} en 
 * @returns 
 */
function getFlagTags(en) {
    var flag = getFlagByEn(en);
    if (!flag) {
        return "";
    }
    if (flag.tags_inherit && flag.parent != null) {
        return getFlagTags(flag.parent);
    }
    if (flag.tags && flag.tags.length) {
        return flag.tags;
    }
    return "";
}
...
/**
 * get all related flags.
 * @param {string} en 
 * @returns 
 */
function getRelatedFlags(en) {
    var relatedFlags = [];
    var tags = getFlagTags(en);
    if (!tags.length) {
        return relatedFlags; // skip if this flag has no tags
    }
    var tagArray = tags.split(",");
    for (var flag of flagImages) {
        if (flag.en == en) continue; // skip self
